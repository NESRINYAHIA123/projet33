                        ...
                        child: Listener(
                          ...
                          child: GestureDetector(
                            ...
                            onPanStart: (value) {
                              ...
                              print('firstDraxX: ${value.localPosition.dx} firstDragY: ${value.localPosition.dy}');

                              print('dragble start x: ${value.localPosition.dx}   -   dragble start y:${value.localPosition.dy}  ');
                            ...
                            onPanUpdate: (value) {
                              ...
                              print('dragble x: ${value.localPosition.dx.toInt()}   -   dragble y:${value.localPosition.dy.toInt()}  ');
                              context.read<PositionsProvider>().setDragCords(x: value.localPosition.dx.toInt(), y: value.localPosition.dy.toInt());
                            ...
                            onPanEnd: (value) {
                              ...
                              print('getDragDx: ${context.read<PositionsProvider>().getDragDx()}');
                              print('getDragDy: ${context.read<PositionsProvider>().getDragDy()}');
